...
<!-- Mirrored from steelcoders.com/modern/admin2/form-x-editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:32:56 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | Forms - X-editable</title>
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-note"></span><p>Forms</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="form-x-editable.html">X-editable</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <form method="get" id="frm" class="form-inline" action="http://steelcoders.com/modern/admin2/form-x-editable.html">
                                        <label>Mode:
...
<!-- Mirrored from steelcoders.com/modern/admin2/form-x-editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:15 GMT -->
</html>