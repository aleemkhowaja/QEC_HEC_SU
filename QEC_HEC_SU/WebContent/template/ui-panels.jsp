...
<!-- Mirrored from steelcoders.com/modern/admin2/ui-panels.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:16 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | UI Kits - Panels</title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper" class="container">
                    <h3 class="m-b-sm">Basic example</h3>
                    <p class="m-b-md">By default, all the <code>.panel</code> does is apply some basic border and padding to contain some content</p>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel">
                    ...
                    <h3 class="m-b-sm">Panel with heading</h3>
                    <p class="m-b-md">Easily add a heading container to your panel with <code>.panel-heading</code>. You may also include any <code>&lt;h1&gt;-&lt;h6&gt;</code> with a <code>.panel-title</code> class to add a pre-styled heading. <br>For proper link coloring, be sure to place links in headings within <code>.panel-title</code>.</p>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <h3 class="m-b-sm">Panel with footer</h3>
                    <p class="m-b-md">Wrap buttons or secondary text in <code>.panel-footer</code>. Note that panel footers <strong>do not</strong> inherit colors and borders when using contextual variations as they are not meant to be in the foreground.</p>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                    ...
                    <h3 class="m-b-sm">Contextual alternatives</h3>
                    <p class="m-b-md">Like other components, easily make a panel more meaningful to a particular context by adding any of the contextual state classes.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                    ...
                    <h3 class="m-b-sm">Panel Controls</h3>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <h3 class="m-b-sm">Colored Panels</h3>
                    <p class="m-b-md">Like other components, easily make a panel more meaningful to a particular context by adding any of the contextual state classes.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-white">
                    ...
                    <h3 class="m-b-sm">With tables</h3>
                    <p class="m-b-md">Add any non-bordered <code>.table</code> within a panel for a seamless design. If there is a <code>.panel-body</code>, we add an extra border to the top of the table for separation.</p>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                    ...
                    <h3 class="m-b-sm">With list groups</h3>
                    <p class="m-b-md">Easily include full-width list groups within any panel.</p>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                    ...
                    <h3 class="m-b-sm">Draggable Panels</h3>
                    <div class="sortable">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-white">
