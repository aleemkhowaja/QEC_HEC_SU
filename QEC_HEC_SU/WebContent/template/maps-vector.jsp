...
<!-- Mirrored from steelcoders.com/modern/admin2/maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:40 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | Maps - Vector Maps</title>
    ...
    <body class="page-header-fixed page-sidebar-fixed compact-menu page-horizontal-bar">
        ...
        <main class="page-content content-wrap full-height">
            <div class="navbar">
            ...
            <div class="page-sidebar sidebar horizontal-bar">
                <div class="page-sidebar-inner">
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-pointer"></span><p>Maps</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="maps-google.html">Google Maps</a></li>
                                <li class="active"><a href="maps-vector.html">Vector Maps</a></li>
                            </ul>
                        </li>
...
<!-- Mirrored from steelcoders.com/modern/admin2/maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:45 GMT -->
</html>