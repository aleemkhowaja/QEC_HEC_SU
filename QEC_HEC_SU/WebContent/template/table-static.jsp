...
<!-- Mirrored from steelcoders.com/modern/admin2/table-static.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:30 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | Static Tables</title>
                ...
                <div class="page-sidebar-inner">
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-grid"></span><p>Tables</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="active"><a href="table-static.html">Static Tables</a></li>
