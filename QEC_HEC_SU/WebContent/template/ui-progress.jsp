...
<!-- Mirrored from steelcoders.com/modern/admin2/ui-progress.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:16 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | UI Kits - Progress Bars</title>
                ...
                <div id="main-wrapper" class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Animated</h4>
                                </div>
                                <div class="panel-body">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Stacked</h4>
                                </div>
                                <div class="panel-body">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Squared</h4>
                                </div>
                                <div class="panel-body">
                                    <p>You can crate squared progress bars by adding <code>.progress-squared</code> class to <code>.progress</code>.</p>
                                    <div class="progress progress-squared">
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Contextual alternatives</h4>
                                </div>
                                <div class="panel-body">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Striped</h4>
                                </div>
                                <div class="panel-body">
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <p>You can also change progress bar size easily by adding one of <code>.progress-xs .progress-sm .progress-md .progress-lg</code> classes to <code>.progress</code>.</p> 
