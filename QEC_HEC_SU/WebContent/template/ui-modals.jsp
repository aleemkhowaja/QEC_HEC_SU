...
<!-- Mirrored from steelcoders.com/modern/admin2/ui-modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:16 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | UI Kits - Modals</title>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <h3>Small Modal</h3>
                                            <p>Modals have small optional size, available by adding <code>.modal-sm</code> class on a <code>.modal-dialog</code>.</p>
                                            <!-- Small modal -->
