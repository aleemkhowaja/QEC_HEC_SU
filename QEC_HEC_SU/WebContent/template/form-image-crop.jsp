...
<!-- Mirrored from steelcoders.com/modern/admin2/form-image-crop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:32:28 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | Forms - Image Crop</title>
        ...
        <link href="assets/plugins/image-cropper/cropper.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="page-header-fixed compact-menu page-horizontal-bar">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-note"></span><p>Forms</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="form-image-crop.html">Image Crop</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="image-crop">
                                                <img src="assets/images/crop.jpg" style="width: 100%; height: 100%;" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <h4>Image Preview:</h4>
                                            ...
                                            <div class="m-t-md">
                                                ...
                                                <div class="input-group m-t-sm">
                                                    ...
                                                    <input class="form-control" id="replaceWith" type="text" value="assets/images/crop.jpg" placeholder="Input image URL">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="assets/js/pages/form-image-crop.js"></script>
        
    </body>

<!-- Mirrored from steelcoders.com/modern/admin2/form-image-crop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:32:34 GMT -->
</html>