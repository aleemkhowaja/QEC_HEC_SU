...
<!-- Mirrored from steelcoders.com/modern/admin2/ui-sliders.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:16 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | UI Kits - Sliders</title>
    ...
    <body class="page-header-fixed compact-menu page-horizontal-bar">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-briefcase"></span><p>UI Kits</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="ui-sliders.html">Sliders</a></li>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label"><b>Default</b><span class="text-muted f-s-12 clearfix">Start without params</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_01">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label"><b>Min-Max</b><span class="text-muted f-s-12 clearfix">Set min value, max value and start point</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_02">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label"><b>Prefix</b><span class="text-muted f-s-12 clearfix">showing grid and adding prefix "$"</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_03">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label"><b>Range</b><span class="text-muted f-s-12 clearfix">Set up range with negative values</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_04">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label"><b>Step</b><span class="text-muted f-s-12 clearfix">Using step 250</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_05">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label"><b>Custom Values</b><span class="text-muted f-s-12 clearfix">Using any strings as values</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_06">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label"><b>Prettify Numbers</b><span class="text-muted f-s-12 clearfix">Prettify enabled. Much better!</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="range_07">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label"><b>Disabled</b><span class="text-muted f-s-12 clearfix">Lock slider by using disable option</span></label>
                                            <div class="col-sm-10">
        ...
        <script src="assets/js/pages/ui-sliders.js"></script>
        
    </body>

<!-- Mirrored from steelcoders.com/modern/admin2/ui-sliders.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:24 GMT -->
</html>