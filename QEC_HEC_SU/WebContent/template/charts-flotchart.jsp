...
<!-- Mirrored from steelcoders.com/modern/admin2/charts-flotchart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:35 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | Charts - Flotchart</title>
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-bar-chart"></span><p>Charts</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="charts-flotchart.html">Flotchart</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <p class="no-s">Flot is a pure JavaScript plotting library for jQuery, with a focus on simple usage, attractive looks and interactive features.</p>
                                </div>
                            </div>
                        </div>
                    </div><!-- Row -->
...
<!-- Mirrored from steelcoders.com/modern/admin2/charts-flotchart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:37 GMT -->
</html>