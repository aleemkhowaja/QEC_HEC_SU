...
<!-- Mirrored from steelcoders.com/modern/admin2/pricing-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:47 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | Extra - Pricing Tables</title>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="cd-pricing-container cd-full-width cd-secondary-theme">
                                        <div class="cd-pricing-switcher">
                                            <p class="fieldset">
                                                <input type="radio" class="no-uniform" name="duration" value="monthly" id="monthly" checked>
                                                <label for="monthly">Monthly</label>
                                                <input type="radio" class="no-uniform" name="duration" value="yearly" id="yearly">
                                    ...
                                    <div class="cd-pricing-container cd-has-margins">
                                        <div class="cd-pricing-switcher">
                                            <p class="fieldset">
                                                <input type="radio" class="no-uniform" name="duration-2" value="monthly" id="monthly-2" checked>
                                                <label for="monthly-2">Monthly</label>
                                                <input type="radio" class="no-uniform" name="duration-2" value="yearly" id="yearly-2">
...
<!-- Mirrored from steelcoders.com/modern/admin2/pricing-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:49 GMT -->
</html>