...
<!-- Mirrored from steelcoders.com/modern/admin2/charts-rickshaw.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:17 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | Charts - Rickshaw Charts</title>
    ...
    <body class="page-header-fixed compact-menu page-horizontal-bar">
            ...
            <div class="page-sidebar sidebar horizontal-bar">
                <div class="page-sidebar-inner">
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-bar-chart"></span><p>Charts</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="charts-sparkline.html">Sparkline</a></li>
                                <li class="active"><a href="charts-rickshaw.html">Rickshaw</a></li>
            ...
            <div class="page-inner">
                <div class="page-breadcrumb">
                    <ol class="breadcrumb container">
                        ...
                        <li class="active">Rickshaw Charts</li>
                    </ol>
                </div>
                <div class="page-title">
                    <div class="container">
                        <h3>Rickshaw Charts</h3>
                    </div>
                </div>
                <div id="main-wrapper" class="container">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <p class="no-s">Rickshaw is a JavaScript toolkit for creating interactive time series graphs. Rickshaw provides the elements you need to create interactive graphs: renderers, legends, hovers, range selectors, etc. You put the pieces together.</p>
                                </div>
                            </div>
                        </div>
                    </div><!-- Row -->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Interactive Real-Time Data Chart</h3>
                                </div>
                                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Simple Area Chart</h3>
                                </div>
                                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Multiple Line Chart</h3>
                                </div>
                                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Multiple Bar Chart</h3>
                                </div>
                                <div class="panel-body">
                                    <div id="rickshaw7"></div> 
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Scatterplot Chart</h3>
                                </div>
                                <div class="panel-body">
                                    <div id="rickshaw8"></div> 
                                </div>
                            </div>
                        </div>
                    </div><!-- Row -->
        ...
        <script src="assets/plugins/d3/d3.layout.min.js"></script>
        <script src="assets/plugins/rickshaw/rickshaw.min.js"></script>
        <script src="assets/js/modern.min.js"></script>
        <script src="assets/js/pages/charts-rickshaw.js"></script>
        
    </body>

<!-- Mirrored from steelcoders.com/modern/admin2/charts-rickshaw.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:27 GMT -->
</html>