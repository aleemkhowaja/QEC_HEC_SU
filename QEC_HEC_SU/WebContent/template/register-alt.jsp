...
<!-- Mirrored from steelcoders.com/modern/admin2/register-alt.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:40 GMT -->
<head>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p class="m-t-xs text-sm">2015 &copy; Modern by Steelcoders.</p>
                                        </div>
                                        <div class="col-md-6">
                                            <form class="m-t-md" action="http://steelcoders.com/modern/admin2/login.html">
