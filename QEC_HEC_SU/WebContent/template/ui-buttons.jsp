...
<!-- Mirrored from steelcoders.com/modern/admin2/ui-buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:15 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | UI Kits - Buttons</title>
                            ...
                            <div class="col-md-8">
                                <div class="panel panel-white">
                                    <div class="panel-heading clearfix">
                                        <h4 class="panel-title">Button Colors</h4>
                                    </div>
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <button type="button" class="btn btn-default btn-addon m-b-sm"><i class="fa fa-plus"></i> Default</button>
                                        <button type="button" class="btn btn-primary btn-addon m-b-sm"><i class="fa fa-plus"></i> Primary</button>
                                        <button type="button" class="btn btn-success btn-addon m-b-sm"><i class="fa fa-plus"></i> Success</button>
                                        <button type="button" class="btn btn-info btn-addon m-b-sm"><i class="fa fa-plus"></i> Info</button>
                                        <button type="button" class="btn btn-warning btn-addon m-b-sm"><i class="fa fa-plus"></i> Warning</button>
                                        <button type="button" class="btn btn-danger btn-addon m-b-sm"><i class="fa fa-plus"></i> Danger</button>
                                        <div class="clearfix"></div>
                                        <button type="button" class="btn btn-primary btn-addon m-b-sm btn-lg"><i class="fa fa-plus"></i> Primary</button>
                                        <button type="button" class="btn btn-primary btn-addon m-b-sm btn-sm"><i class="fa fa-plus"></i> Primary</button>
                                        <button type="button" class="btn btn-primary btn-addon m-b-sm btn-xs"><i class="fa fa-plus"></i> Primary</button>
                                        <div class="clearfix"></div>
                                        <button type="button" class="btn btn-primary btn-addon m-b-sm btn-rounded"><i class="fa fa-plus"></i> Primary</button>
                                        <button type="button" class="btn btn-primary btn-addon m-b-sm btn-rounded btn-lg"><i class="fa fa-plus"></i> Primary</button>
                                        <button type="button" class="btn btn-primary btn-addon m-b-sm btn-rounded btn-md"><i class="fa fa-plus"></i> Primary</button>
                                        <button type="button" class="btn btn-primary btn-addon m-b-sm btn-rounded btn-sm"><i class="fa fa-plus"></i> Primary</button>
                                    </div>
                                </div>
                                <div class="panel panel-white">
                                    <div class="panel-heading clearfix">
                                    ...
                                    <div class="panel-body">
                                        <button type="button" class="btn btn-facebook m-b-xs"><i class="fa fa-facebook"></i></button>
                                        <button type="button" class="btn btn-twitter m-b-xs"><i class="fa fa-twitter"></i></button>
                                        <button type="button" class="btn btn-google m-b-xs"><i class="fa fa-google-plus"></i></button>
                                        <button type="button" class="btn btn-youtube m-b-xs"><i class="fa fa-youtube"></i></button>
                                        <button type="button" class="btn btn-vimeo m-b-xs"><i class="fa fa-vimeo-square"></i></button>
                                        <button type="button" class="btn btn-dribbble m-b-xs"><i class="fa fa-dribbble"></i></button>
                                        <button type="button" class="btn btn-github m-b-xs"><i class="fa fa-github"></i></button>
                                        <button type="button" class="btn btn-instagram m-b-xs"><i class="fa fa-instagram"></i></button>
                                        <button type="button" class="btn btn-pinterest m-b-xs"><i class="fa fa-pinterest"></i></button>
                                        <button type="button" class="btn btn-vk m-b-xs"><i class="fa fa-vk"></i></button>
                                        <button type="button" class="btn btn-rss m-b-xs"><i class="fa fa-rss"></i></button>
                                        <button type="button" class="btn btn-flickr m-b-xs"><i class="fa fa-flickr"></i></button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <h4 class="m-t-md">Vertical</h4>
                                        <div class="btn-group-vertical m-t-xs" role="group" aria-label="Vertical button group">
                                            <button type="button" class="btn btn-default">Top</button>
                                            <button type="button" class="btn btn-default">Middle</button>
                                            <button type="button" class="btn btn-default">Bottom</button>
                                        </div>
                                        <h4 class="m-t-md">Justified</h4>
                                        <div class="btn-group btn-group-justified" role="group" aria-label="Justified button group">
                                            <a href="#" class="btn btn-info" role="button">Left</a>
                                            <a href="#" class="btn btn-primary" role="button">Middle</a>
                                            <a href="#" class="btn btn-warning" role="button">Right</a>
                                        </div>
                                        <h4 class="m-t-md">Nested</h4>
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-default">1</button>
                                            <button type="button" class="btn btn-default">2</button>
