...
<!-- Mirrored from steelcoders.com/modern/admin2/form-image-zoom.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:32:34 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | Forms - Image Zoom</title>
    ...
    <body class="page-header-fixed compact-menu page-horizontal-bar">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-note"></span><p>Forms</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="form-image-zoom.html">Image Zoom</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Basic Zoom</h4>
                                </div>
                                <div class="panel-body">
                                    <img id="zoom_01" src="assets/images/zoom/small/image1.jpg" data-zoom-image="assets/images/zoom/large/image1.jpg" style="width: 100%;"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <img id="zoom_02" src="assets/images/zoom/small/image2.jpg" data-zoom-image="assets/images/zoom/large/image2.jpg" style="width: 100%;"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <img id="zoom_04" src="assets/images/zoom/small/image4.jpg" data-zoom-image="assets/images/zoom/large/image4.jpg" style="width: 100%;"/>
                                </div>
                            </div>
                        </div>
                    </div><!-- Row -->
        ...
        <script src="assets/js/pages/form-image-zoom.js"></script>
        
    </body>

<!-- Mirrored from steelcoders.com/modern/admin2/form-image-zoom.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:32:51 GMT -->
</html>