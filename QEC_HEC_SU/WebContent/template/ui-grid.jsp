...
<!-- Mirrored from steelcoders.com/modern/admin2/ui-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:16 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | UI Kits - Grid</title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper" class="container">
                    <p class="lead">Stacked to horizontal</p>
                    <div class="row">
                        <div class="col-md-2">
                            <div class="panel">
                    ...
                    <p class="lead">Mobile and desktop</p>
                    ...
                    <p class="lead">Mobile, tablet, desktop</p>
                    <div class="row">
                    ...
                    <p class="lead">Offsetting columns</p>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-body">
                    ...
                    <p class="lead">Column ordering</p>
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="panel">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Grid options</h4>
                                </div>
                                <div class="panel-body">
