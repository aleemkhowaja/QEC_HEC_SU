...
<!-- Mirrored from steelcoders.com/modern/admin2/ui-tree-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:28 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | UI Kits - Tree View</title>
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-briefcase"></span><p>UI Kits</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="ui-tree-view.html">Tree View</a></li>
                            </ul>
                        </li>
                ...
                <div id="main-wrapper" class="container">
                    <div class="row">
                                        ...
                                        <ul>
                                            ...
                                            <li>Root node
                                                <ul>
                                                    ...
                                                    <li data-jstree='{"icon":"fa fa-tags icon-state-primary icon-md"}'>Custom icon</li>
                                                </ul>
                                            </li>
                                            <li data-jstree='{"type":"file"}'>File type</li>
                                        </ul>
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h3 class="panel-title">Checkbox Tree</h3>
                                </div>
                                <div class="panel-body">
                                    <div id="checkTree">
                                        <ul>
...
<!-- Mirrored from steelcoders.com/modern/admin2/ui-tree-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:30 GMT -->
</html>