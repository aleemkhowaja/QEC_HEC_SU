...
<!-- Mirrored from steelcoders.com/modern/admin2/ui-typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:31:15 GMT -->
<head>
        
        <!-- Title -->
        <title>Modern | UI Kits - Typography</title>
                ...
                <div id="main-wrapper" class="container">
                    <div class="row">
                        <div class="col-sm-12 col-lg-8">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="m-t-xxs">h1. heading <small>Secondary text</small></h1>
                                        ...
                                        <div class="col-md-6"> 
                                            <h3>Lead Text</h3>
                                            <p class="lead">Make a paragraph stand out by adding 'lead' class</p>
                        ...
                        <div class="col-sm-12 col-lg-4">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Inline List</h4>
                                    <div class="panel-control">
                                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" class="panel-collapse" data-original-title="Expand/Collapse"><i class="icon-arrow-down"></i></a>
                                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" class="panel-reload" data-original-title="Reload"><i class="icon-reload"></i></a>
                                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" class="panel-remove" data-original-title="Remove"><i class="icon-close"></i></a>
