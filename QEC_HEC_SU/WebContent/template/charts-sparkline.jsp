...
<!-- Mirrored from steelcoders.com/modern/admin2/charts-sparkline.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:15 GMT -->
<head>
                ...
                <div class="page-sidebar-inner">
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-bar-chart"></span><p>Charts</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="active"><a href="charts-sparkline.html">Sparkline</a></li>
                ...
                <div id="main-wrapper" class="container">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <p class="no-s">This jQuery plugin generates sparklines (small inline charts) directly in the browser using data supplied either inline in the HTML, or via javascript. The plugin is compatible with most modern browsers and has been tested with Firefox 2+, Safari 3+, Opera 9, Google Chrome and Internet Explorer 6, 7, 8, 9 &amp; 10 as well as iOS and Android.</p>
                                </div>
                            </div>
                        </div>
                    </div><!-- Row -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Custom Line Chart</h3>
                                </div>
                                <div class="panel-body">
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Mouse Speed Chart Example</h3>
                                </div>
                                <div class="panel-body">
                                    <div id="sparkline5" class="text-center" height="165px"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Composite bar Chart</h3>
                                </div>
                                <div class="panel-body">
...
<!-- Mirrored from steelcoders.com/modern/admin2/charts-sparkline.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 07:33:16 GMT -->
</html>