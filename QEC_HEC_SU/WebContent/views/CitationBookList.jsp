...
<html xmlns="http://www.w3.org/1999/xhtml">
	<!-------------------- crud urls  ---------------------------->
	<c:url var="returnAllBookForGrid" value="/qec/book/returnAllCitationBookForGrid" ></c:url>
	<!-- ------------------------------------------------------ -->
	...
	<body class="page-header-fixed compact-menu page-horizontal-bar">
		...
		<div class="page-inner">
		    <div class="page-title">
		        <div class="container">
		        	<div class="adv_ser_row" >
						...
						<!-- Start Search Fields -->
						<span> 
							<input class="smallinput" type="text" name="bookTitle" id="bookTitle" placeholder="Book Title" />
							<input type="button" value="Search" id="search-book-button" />
						</span>
					</div>
					
					<table id="book-detail-grid-list" class="grid-container">
                		<tr>
                			<td />
                		</tr>
        			</table>
    		...
    		<div id="main-wrapper" class="container">
				<div id="book-detail-grid-list" class="grid-container"></div>
				<div style="clear: both;"></div>
				<!-- include book detail page -->
				<jsp:include page="CitationBookDetail.jsp" />

				<script type="text/javascript">
					$(document).ready(function(){
						var token = $("meta[name='_csrf']").attr("content");
					    var header = $("meta[name='_csrf_header']").attr("content");
						 $("#book-detail-grid-list").jqGrid({
							url : "${returnAllBookForGrid}",
