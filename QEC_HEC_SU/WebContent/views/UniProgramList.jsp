	...
	<body class="page-header-fixed compact-menu page-horizontal-bar">
		...
		<div class="page-inner">
		        ...
		        <div class="container">
		        	<div class="adv_ser_row" >
		        		<h2>Programs</h2>
							<!-- Start Search Fields -->
							<span> 
								<input class="smallinput" type="text" name="uniProgramsName" id="uniProgramsName" placeholder="Program Name" />
								<input type="button" value="Search" id="search-program-button" />
							</span>
					</div>
					
					<table id="uni-programs-detail-grid-list">
                		<tr>
                			<td />
                		</tr>
        			</table>
    		...
    		<div id="main-wrapper" class="container">
				<div id="uni-programs-detail-grid" class="grid-container"></div>
				<div style="clear: both;"></div>
				
				<jsp:include page="UniProgramDetail.jsp" />
				...
				<script type="text/javascript">
					...
					$(document).ready(function(){
						 ...
						 $("#uni-programs-detail-grid-list").jqGrid({
							...
							width : 1000,
							height : 400,
							colNames : [ 'uniProgramsId','Program Code','Program Name'],
							colModel : [ /* {
