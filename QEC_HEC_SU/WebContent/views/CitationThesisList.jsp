...
<html xmlns="http://www.w3.org/1999/xhtml">
	<!-------------------- crud urls  ---------------------------->
	<c:url var="returnAllThesisForGrid" value="/qec/thesis/returnAllCitationThesisForGrid" ></c:url>
	<!-- ------------------------------------------------------ -->
	...
	<body class="page-header-fixed compact-menu page-horizontal-bar">
		...
		<div class="page-inner">
		    <div class="page-title">
		        <div class="container">
		        	<div class="adv_ser_row" >
						...
						<!-- Start Search Fields -->
						<span> 
							<input class="smallinput" type="text" name="thesisTitle" id="thesisTitle" placeholder="Thesis Title" />
							<input type="button" value="Search" id="search-thesis-button" />
						</span>
					</div>
					
					<table id="thesis-detail-grid-list" class="grid-container">
                		<tr>
                			<td />
                		</tr>
        			</table>
    		...
    		<div id="main-wrapper" class="container">
				<div id="thesis-detail-grid-list" class="grid-container"></div>
				<div style="clear: both;"></div>
				<!-- include thesis detail page -->
				<jsp:include page="CitationThesisDetail.jsp" />

				<script type="text/javascript">
					$(document).ready(function(){
						var token = $("meta[name='_csrf']").attr("content");
					    var header = $("meta[name='_csrf_header']").attr("content");
						 $("#thesis-detail-grid-list").jqGrid({
							url : "${returnAllThesisForGrid}",
							...
							colModel : [
								...
								{
									name : 'citationThesisId',
							        index : 'citationThesisId',
							        width : 150,
							        hidden : true,
									key : true,
								}
						...
						// activate the toolbar searching
							...
							$('#search-thesis-button').on('click',function(){
